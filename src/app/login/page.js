            ...
            <div style={{ flex: 1, display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '2rem', background: 'white' }}>
                <div style={{ width: '100%', maxWidth: '420px' }}>
                    <FadeIn>
                        ...
                        {/* Role Toggle */}
                        <div style={{ display: 'flex', background: '#F1F5F9', padding: '0.375rem', borderRadius: '0.75rem', marginBottom: '2rem' }}>
                            {['buyer', 'agent', 'admin'].map((r) => (
                                <button
                                    ...
                                    style={{
                                        ...
                                        color: role === r ? 'var(--foreground)' : 'var(--muted)',
